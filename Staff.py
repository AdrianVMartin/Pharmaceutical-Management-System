...
#==============================label frame================================================#
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Student Information",font=("times new roman",12,"bold"),fg="black",bg="light blue")
...
#==========================================buttons======================================================#
        ...
        def add_data():
            if self.var_mobile.get()=="" or self.var_mother.get()=="":
                ...
                try:
                    conn=mysql.connector.connect(host="localhost",username="root",password="akash",database="pms")
